...
if __name__ == "__main__" :
    path_images='./CODEBRIM_original_images/original_dataset/images/'
    path_annotations='./CODEBRIM_original_images/original_dataset/annotations/'
    output='./data_raw/'
    prepare_codebrim_yolo(path_images, path_annotations, output)
